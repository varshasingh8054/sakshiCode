  ...
  getProfile(){
    this.authService.getProfile().then(res =>{
      ...
      this.editForm.patchValue({
        ...
        practiseName: this.profileDetails['addedByPracticeAdmin']['practiseName'],
        streetAdd1: this.profileDetails['addedByPracticeAdmin']['streetAdd1'],
        streetAdd2: this.profileDetails['addedByPracticeAdmin']['streetAdd2'],
        state: this.profileDetails['addedByPracticeAdmin']['state'],
        city: this.profileDetails['addedByPracticeAdmin']['city'],
        country: this.profileDetails['addedByPracticeAdmin']['country'],
        postalCode: this.profileDetails['addedByPracticeAdmin']['postalCode'],
        phoneNumber: this.profileDetails['addedByPracticeAdmin']['phoneNumber']
      });
